...
class Molecule:
    def __init__(self, name, symbols, coordinates):
        ...
        self._coordinates = coordinates  # the attribute is private
...
if __name__ == "__main__":
    ...
    mol = Molecule(name, symbols, random_coordinates)

    print(F'Coords are {mol.coordinates}')

    random_coordinates += 100
    mol = Molecule(name, symbols, random_coordinates)

    print(F'\nCoords are {mol.coordinates}')
